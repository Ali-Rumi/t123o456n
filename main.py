...
class TradingStrategy:
    ...
    def run_bnb_long(self):
        try:
            subprocess.Popen(["python", "ton_long.py"])
            print("Running ton_long.py")
        except Exception as e:
            print(f"Error running ton_long.py: {e}")

    def run_bnb_short(self):
        try:
            subprocess.Popen(["python", "ton_short.py"])
            print("Running ton_short.py")
        except Exception as e:
            print(f"Error running ton_short.py: {e}")
